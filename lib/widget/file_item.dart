...
import 'package:jinvideo/utils/datetime_utils.dart';
import 'package:jinvideo/utils/my_icons_utils.dart';
/// 文件widget
class FileItem extends StatelessWidget {
  const FileItem({Key? key, required this.fileModel, this.leadingWidget, this.subtitleWidget, this.trailingWidget, this.onTap}) : super(key: key);
