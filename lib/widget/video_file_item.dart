...
class VideoFileItem extends StatelessWidget {
  const VideoFileItem({Key? key, required this.fileModel, this.onTap}) : super(key: key);
  ...
  List<Widget> _createOperateList(FileModel fileModel) {
    ...
    Widget subtitlesWidget = TextButton.icon(
      ...
      onPressed: () {
        ...
        EasyLoading.showToast("功能暂未实现", toastPosition: EasyLoadingToastPosition.bottom);
                ...
                actions: [
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      ...
                      EasyLoading.showToast("移除成功", toastPosition: EasyLoadingToastPosition.bottom);
                      bool open = Get.isDialogOpen ?? false;
                      if(open) {
                        Get.back();
                      }
            ...
            onPressed: () {
              ...
              if (newName != oldName) {
                ...
                try {
                  ...
                  EasyLoading.showToast("修改失败，请确认原文件是否存在", toastPosition: EasyLoadingToastPosition.bottom);
                }
                bool open = Get.isDialogOpen ?? false;
                if (open) {
                  Get.back();
              ...
              return DirectoryItem(
                ...
                onTap: () {
                  ...
                  if (toastText.isNotEmpty) {
                    EasyLoading.showToast(toastText, toastPosition: EasyLoadingToastPosition.bottom);
                  }
                },
